/**
 * Complete list of all static routes for prerendering.
 * Dynamic routes (e.g., /resources/author/:slug/) are excluded.
 */
export const staticRoutes = [
  ...
  "/comparisons/notiproof-vs-trustpulse/",
  "/comparisons/notiproof-vs-proof/",
  ...
  // Case Studies
  "/case-studies/",
  "/case-studies/ecommerce-stylehaven/",
  "/case-studies/saas-conversion/",
  "/case-studies/agency-brightpath/",
  "/case-studies/local-business-greenleaf/",

  // Free Tools
  "/free-tools/",
  "/free-tools/ab-test-calculator/",
