  ...
  return (
    <>
      <SEOHead
        ...
        description="NotiProof's terms of service. Read the terms and conditions governing your use of our social proof and testimonial platform."
      ...
      <section className="section-padding">
        <div className="container-tight">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p>
              By accessing or using NotiProof's website and services (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree, you must not use the Service. These Terms constitute a legally binding agreement between you and NotiProof.
            </p>
            ...
            <ul>
              ...
              <li><strong>"We," "us," "our"</strong> refers to NotiProof.</li>
            ...
            <h3>5.3 No Free Trial on Paid Plans</h3>
            <p>
            ...
            <h2>9. User Content & Data Ownership</h2>
            <ul>
              <li>You retain full ownership of all User Content you upload to the Service.</li>
              <li>By uploading content, you grant NotiProof a limited, non-exclusive, worldwide license to host, display, and distribute your content solely for the purpose of operating the Service.</li>
            ...
            <ul>
              <li>NotiProof retains all rights, title, and interest in the Service, including software, branding, logos, documentation, and all related intellectual property.</li>
              <li>These Terms do not grant you any right to use NotiProof's trademarks, logos, or branding without prior written consent.</li>
            ...
            <h2>11. DMCA & Copyright Complaints</h2>
            <p>
              We respect intellectual property rights. If you believe content on our platform infringes your copyright, please send a DMCA takedown notice to <strong>legal@notiproof.com</strong> including:
            </p>
            <ol>
            ...
            <h2>12. Third-Party Services & Integrations</h2>
            <p>
              The Service integrates with third-party platforms (e.g., Shopify, WordPress, Zapier, Stripe, Google). Your use of third-party services is governed by their respective terms and privacy policies. NotiProof is not responsible for the availability, accuracy, or practices of third-party services.
            </p>

            <h2>13. Privacy & Data Processing</h2>
            <p>
            ...
            <h2>14. Service Availability & SLA</h2>
            <ul>
            ...
            <ul>
              <li>NotiProof's total aggregate liability arising from or related to these Terms shall not exceed the amounts you paid for the Service in the <strong>twelve (12) months</strong> preceding the claim.</li>
            ...
            <p>
              You agree to indemnify, defend, and hold harmless NotiProof, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including reasonable attorneys' fees) arising from:
            </p>
            <ul>
            ...
            <p>
              These Terms are governed by and construed in accordance with the laws of the State of Delaware, United States, without regard to conflict of law principles. For users in the European Union, mandatory consumer protection laws of your country of residence shall apply where required.
            </p>
            ...
            <ul>
              ...
              <li>Provisions that by their nature should survive termination will survive, including Sections 10, 15, 16, 17, and 18.</li>
            </ul>
