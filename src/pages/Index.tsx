    ...
    <>
        ...
        <div className="container-tight">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
            {integrations.map((name) => (
              <span key={name} className="text-sm font-semibold text-muted-foreground/60 hover:text-foreground transition-colors">{name}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { title: "No Trust Signals", desc: "Visitors can't see that others are buying, signing up, or engaging with your product." },
              { title: "No Urgency", desc: "Without real-time activity, visitors feel no pressure to take action now." },
              { title: "No Social Proof", desc: "Testimonials buried on a page nobody visits don't convert. They need to be front and center." },
            ].map((item) => (
              <motion.div key={item.title} {...fadeUp} className="bg-card border border-border rounded-xl p-6">
      ...
      <section className="section-padding">
        <div className="container-tight">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {useCases.map((uc) => (
              <Link key={uc.title} to={uc.href} className="group bg-card border border-border rounded-xl p-6 hover:shadow-lg hover:border-primary/30 transition-all duration-300">
      ...
      <section className="section-padding bg-surface">
        <div className="container-tight">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              <motion.div key={t.name} {...fadeUp} className="bg-card border border-border rounded-xl p-6">
      ...
      <section className="section-padding bg-surface">
        <div className="container-tight">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {plans.map((p) => (
              <div key={p.name} className={`bg-card border rounded-xl p-6 text-center relative ${p.popular ? "border-primary shadow-lg shadow-primary/10 ring-2 ring-primary" : "border-border"}`}>
                {p.popular && (
