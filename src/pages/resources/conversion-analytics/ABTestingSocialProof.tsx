...
const tocSections = [
  ...
  { id: "what-to-test", label: "What Social Proof Elements Do You Test?" },
  { id: "test-design", label: "How Do You Design a Valid A/B Test?" },
  { id: "sample-size", label: "How Large Large Does Your Sample Size Need to Be?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>A/B testing social proof means splitting your traffic between two or more versions of a page — each showing different social proof elements — and measuring which version produces more conversions with statistical significance.</strong></p>
          ...
          <p className="text-muted-foreground">Every social proof element on your site must be tested. The notification message that intuitively seems best often loses to an unexpected variant. Data beats intuition — the only way to know what converts best for your specific audience is to test it.</p>

          <h2 id="what-to-test" className="text-2xl font-bold mt-12">What Social Proof Elements Do You Test?</h2>
          <p className="text-foreground"><strong>Test these variables in priority order: social proof type (notifications vs. testimonials vs. counters), message content, visual design, placement/position, timing and frequency, and targeting rules.</strong></p>
          ...
          <p className="text-foreground"><strong>A valid test requires a single isolated variable (change one thing at a time), random traffic assignment, a meaningful conversion metric, sufficient sample size, and enough runtime to account for day-of-week and seasonal variations.</strong></p>
          ...
          <h2 id="sample-size" className="text-2xl font-bold mt-12">How Large Large Does Your Sample Size Need to Be?</h2>
          <p className="text-foreground"><strong>Most social proof A/B tests need 1,000-5,000 visitors per variant to detect a 10-20% relative lift with 95% confidence — meaning a test on a page with 500 daily visitors needs 4-20 days to reach significance.</strong></p>
          ...
          <p className="text-foreground"><strong>Message personalization (location, product name) and notification type (purchase vs. review vs. signup) consistently produce the largest conversion differences — often 20-50% relative lift between best and worst variants.</strong></p>
          ...
          <p className="text-foreground"><strong>Yes — notification position (bottom-left vs. bottom-right vs. top-bar) can produce 10-30% differences in engagement, and the optimal position varies by page type, device, and audience.</strong></p>
          ...
          <p className="text-foreground"><strong>Wait for 95% statistical significance, check that the sample is representative (equal distribution across days and segments), verify the lift is practically meaningful (not just statistically significant), and document learnings for future tests.</strong></p>
          ...
          <p className="text-foreground"><strong>The most damaging pitfalls are stopping tests too early, testing too many variables simultaneously, ignoring segment-level differences, and not accounting for external factors like seasonality or marketing campaigns.</strong></p>
