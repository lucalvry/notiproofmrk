...
const tocSections = [
  ...
  { id: "reporting", label: "How Should You Report Social Proof ROI?" },
  { id: "benchmarks", label: "What ROI Should You Expect?" },
];
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <h2 id="why-measure-roi" className="text-2xl font-bold mt-12">Why Is Measuring Social Proof ROI Important?</h2>
          <p className="font-medium text-foreground">Measuring ROI justifies continued investment, identifies which social proof types deliver the highest returns, and provides data-driven guidance for optimization — turning social proof from a "nice to have" into a proven revenue driver.</p>
          ...
          <h2 id="key-metrics" className="text-2xl font-bold mt-12">What Metrics Should You Track?</h2>
          <p className="font-medium text-foreground">Track four tiers: engagement metrics (impressions, clicks), conversion metrics (conversion rate, conversion lift), revenue metrics (attributed revenue, AOV change), and efficiency metrics (ROI, cost per acquisition impact).</p>
          ...
          <h2 id="attribution-models" className="text-2xl font-bold mt-12">Which Attribution Model Should You Use?</h2>
          <p className="font-medium text-foreground">Use last-touch attribution for conservative estimates (only credit conversions where social proof was the last interaction) or multi-touch attribution for a more complete picture (credit social proof as one of several conversion influences).</p>
          ...
          <p className="font-medium text-foreground">Establish a clean baseline by measuring conversion rate, revenue, and AOV for 2-4 weeks before implementing social proof, then compare against the same metrics for 2-4 weeks after — controlling for seasonality, traffic source mix, and external factors.</p>
          ...
          <p className="font-medium text-foreground">Revenue attribution formula: (Conversions with social proof interaction × average order value) - (Expected conversions without social proof × average order value) = Revenue attributable to social proof.</p>
          ...
          <h2 id="reporting" className="text-2xl font-bold mt-12">How Should You Report Social Proof ROI?</h2>
          <p className="font-medium text-foreground">Report ROI using three numbers: total attributed revenue, cost of the tool, and ROI multiple. "NotiProof generated $72,000 in attributed revenue this year at a cost of $2,400 — a 30x ROI." Keep it simple and business-focused.</p>
          ...
          <h2 id="benchmarks" className="text-2xl font-bold mt-12">What ROI Should You Expect?</h2>
          <p className="font-medium text-foreground">Most businesses see 10-30x ROI on social proof tools within the first 3 months — driven by a 10-35% conversion lift against a relatively low tool cost, making social proof one of the highest-ROI marketing investments available.</p>
