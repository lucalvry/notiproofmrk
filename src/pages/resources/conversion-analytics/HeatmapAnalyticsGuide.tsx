...
const tocSections = [
  ...
  { id: "types", label: "What Types of Heatmaps Do You Use?" },
  ...
  { id: "tools", label: "Which Heatmap Tools Do You Use?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <h2 id="what-are-heatmaps" className="text-2xl font-bold mt-12">What Are <dfn><Link to="/resources/glossary/" className="text-primary hover:underline">Heatmaps</Link></dfn> and Why Do They Matter?</h2>
          <p className="text-foreground"><strong>Heatmaps are visual representations of user behavior data — showing where visitors click, how far they scroll, and where their attention concentrates on a page, using color gradients from cool (low activity) to hot (high activity).</strong></p>
          ...
          <h2 id="types" className="text-2xl font-bold mt-12">What Types of Heatmaps Do You Use?</h2>
          <p className="text-foreground"><strong>Use three complementary types: click heatmaps (where visitors click), scroll heatmaps (how far visitors scroll), and attention/movement heatmaps (where visitors look and hover) — each reveals different optimization opportunities.</strong></p>
          ...
          <p className="text-foreground"><strong>Use heatmap data to place social proof elements in the intersection of high attention areas and proximity to conversion elements — where they'll be seen by the most visitors at the moment of decision.</strong></p>
          ...
          <p className="text-foreground"><strong>Read heatmaps by looking for patterns: hot zones (red/orange areas of concentrated activity), cold zones (blue areas of low engagement), F-pattern or Z-pattern reading behavior, and the scroll depth where more than 50% of visitors drop off.</strong></p>
          ...
          <p className="text-foreground"><strong>Extract these specific insights: which social proof elements are being ignored (cold zones), whether visitors scroll to your testimonial section, whether notification popups are being dismissed or engaged, and whether social proof near CTAs increases CTA engagement.</strong></p>
          ...
          <p className="text-foreground"><strong>Use heatmaps to generate placement hypotheses, then validate those hypotheses through <Link to="/resources/conversion-analytics/ab-testing-social-proof/" className="text-primary font-semibold hover:underline">A/B tests</Link> — heatmaps tell you where to test, A/B tests tell you if the change actually improves conversions.</strong></p>
