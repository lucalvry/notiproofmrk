...
const tocSections = [
  ...
  { id: "guided-prompts", label: "What Prompts Do You Give Customers?" },
  { id: "technical-quality", label: "How Do You Ensure Good Video Quality?" },
  { id: "editing-and-format", label: "How Do You Edit Video Testimonials?" },
  { id: "display-strategies", label: "Where Do You Display Video Testimonials?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Video testimonials convert 4x better than text because they transmit emotional authenticity through facial expressions, vocal tone, and body language — signals that text cannot convey and that humans are hardwired to trust.</strong></p>
          ...
          <p className="text-foreground"><strong>Browser-based recording tools produce the best balance of quality and response rate — customers simply click a link and record from their device, with no app downloads, no scheduling, and no technical setup required.</strong></p>
          ...
          <h2 id="guided-prompts" className="text-2xl font-bold mt-12">What Prompts Do You Give Customers?</h2>
          <p className="text-foreground"><strong>Provide 3-5 specific, sequential prompts that guide the customer through a problem-solution-result narrative — without scripting their words. This produces focused, compelling testimonials while maintaining authenticity.</strong></p>
          ...
          <p className="text-foreground"><strong>Good lighting and clear audio matter far more than camera resolution — a well-lit smartphone video with clear sound is more effective than a poorly lit professional camera recording with echo.</strong></p>
          ...
          <h2 id="editing-and-format" className="text-2xl font-bold mt-12">How Do You Edit Video Testimonials?</h2>
          <p className="text-foreground"><strong>Keep editing minimal — trim the beginning and end, remove long pauses, add subtitles, and include a brief intro/outro with your branding. Over-editing destroys the authenticity that makes video testimonials effective.</strong></p>
          ...
          <h2 id="display-strategies" className="text-2xl font-bold mt-12">Where Do You Display Video Testimonials?</h2>
          <p className="text-foreground"><strong>Place video testimonials on landing pages (above or near CTAs), homepage hero sections, pricing pages, and dedicated testimonial galleries — prioritizing pages where visitors are making purchase decisions.</strong></p>
          ...
          <p className="text-foreground"><strong>Video transcriptions add indexable, keyword-rich text content to your pages — improving organic search visibility for long-tail queries while making testimonials accessible to visitors who prefer reading.</strong></p>
