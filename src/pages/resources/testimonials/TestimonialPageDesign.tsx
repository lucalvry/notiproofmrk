...
const tocSections = [
  ...
  { id: "page-structure", label: "What Structure Does a Testimonial Page Follow?" },
  { id: "design-principles", label: "What Design Principles Build Maximum Trust?" },
  { id: "testimonial-formats", label: "Which Testimonial Formats Do You Include?" },
  { id: "filtering-sorting", label: "Does Filtering and Sorting Help?" },
  { id: "cta-placement", label: "Where Do You Place CTAs on Testimonial Pages?" },
  { id: "seo-optimization", label: "How Do You Optimize Testimonial Pages for SEO?" },
  { id: "common-mistakes", label: "What Mistakes Do You Avoid?" },
];
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>A dedicated testimonial page serves as a comprehensive trust library for prospects in the final decision stage — providing deeper social proof than scattered quotes on other pages can achieve.</strong></p>
          ...
          <h2 id="page-structure" className="text-2xl font-bold mt-12">What Structure Does a Testimonial Page Follow?</h2>
          <p className="text-foreground"><strong>Structure your page with a hero section featuring your aggregate rating and a headline, followed by featured testimonials (3-5 best stories), then a filterable grid of all testimonials, and end with a clear CTA.</strong></p>
          ...
          <p className="text-muted-foreground"><strong className="text-foreground">White space:</strong> Don't cram testimonials together. Generous spacing between testimonial cards creates a premium feel and prevents visual overwhelm. Each testimonial must breathe as its own unit of social proof.</p>

          <h2 id="testimonial-formats" className="text-2xl font-bold mt-12">Which Testimonial Formats Do You Include?</h2>
          <p className="text-foreground"><strong>Include a mix of short quote cards (1-2 sentences), detailed story cards (2-3 paragraphs with metrics), video testimonials, and case study links — each format serves a different reader behavior and trust-building function.</strong></p>
          ...
          <h2 id="filtering-sorting" className="text-2xl font-bold mt-12">Does Filtering and Sorting Help?</h2>
          <p className="text-foreground"><strong>Yes — filtering by industry, company size, use case, and format (text/video) helps prospects find testimonials from businesses like theirs, making the social proof more relevant and persuasive.</strong></p>
          ...
          <p className="text-muted-foreground">Default sorting must show the most recent or most impactful testimonials first. Recency signals ongoing satisfaction, while impact-first ordering puts your best foot forward. Let visitors switch between "Most recent," "Most helpful," or "Highest rated."</p>

          <h2 id="cta-placement" className="text-2xl font-bold mt-12">Where Do You Place CTAs on Testimonial Pages?</h2>
          <p className="text-foreground"><strong>Place CTAs in three positions: a subtle inline CTA after the featured testimonials section, a sticky header/button during scroll, and a prominent full-width CTA section at the bottom of the page.</strong></p>
          ...
          <p className="text-muted-foreground">Avoid interrupting the testimonial browsing experience with aggressive popups or overlays. The CTAs feels like natural next steps: "Impressed? Start your free trial" or "See these results for yourself — book a demo." The tone must be confident, not desperate.</p>

          <h2 id="seo-optimization" className="text-2xl font-bold mt-12">How Do You Optimize Testimonial Pages for SEO?</h2>
          <p className="text-foreground"><strong>Optimize with a keyword-rich H1 targeting "[brand] reviews" or "[brand] testimonials," AggregateRating schema markup, unique page copy alongside testimonials, and internal links to product pages and related content.</strong></p>
          <p className="text-muted-foreground">Your testimonial page must target branded review queries ("NotiProof reviews," "NotiProof testimonials," "NotiProof customer results"). These are high-intent, bottom-of-funnel searches from prospects actively evaluating your product. Ranking for your own branded review terms prevents competitors from capturing that traffic.</p>
          ...
          <h2 id="common-mistakes" className="text-2xl font-bold mt-12">What Mistakes Do You Avoid?</h2>
          <p className="text-foreground"><strong>Avoid these trust-killing mistakes: using stock photos, showing only perfect 5-star reviews, displaying testimonials without attribution, neglecting mobile optimization, and failing to update testimonials regularly.</strong></p>
