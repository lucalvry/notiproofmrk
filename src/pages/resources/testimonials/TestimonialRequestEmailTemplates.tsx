...
const tocSections = [
  ...
  { id: "follow-up", label: "How Do You Follow Up on Unanswered Requests?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Milestone-triggered requests achieve the highest response rates (15-25%) because they arrive when the customer is experiencing peak satisfaction from a tangible achievement with your product.</strong></p>
          <div className="bg-muted/50 border border-border rounded-xl p-6 my-4">
          ...
          <p className="text-foreground"><strong>After a support ticket is rated 5/5 or the customer explicitly thanks your team, redirect that positive energy into a testimonial request within 24 hours.</strong></p>
          <div className="bg-muted/50 border border-border rounded-xl p-6 my-4">
          ...
          <h2 id="follow-up" className="text-2xl font-bold mt-12">How Do You Follow Up on Unanswered Requests?</h2>
          <p className="text-foreground"><strong>Send one gentle follow-up 5-7 days after the initial request — keep it shorter than the original, acknowledge they're busy, and reiterate the time commitment. Never send more than two total requests.</strong></p>
          <div className="bg-muted/50 border border-border rounded-xl p-6 my-4">
          ...
          <p className="text-foreground"><strong>At minimum, personalize the customer's first name and the specific product or service they purchased. Ideally, reference a specific result or interaction — emails with product-specific personalization achieve 26% higher response rates.</strong></p>
          ...
          <p className="text-foreground"><strong>The highest-performing subject lines are short (under 50 characters), personal, and either ask a question or reference a specific experience — achieving 45-60% open rates compared to 15-25% for generic "feedback request" subjects.</strong></p>
