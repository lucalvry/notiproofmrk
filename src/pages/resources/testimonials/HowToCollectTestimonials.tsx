...
const tocSections = [
  ...
  { id: "what-to-ask", label: "What Questions Do You Ask?" },
  { id: "collection-methods", label: "What Are the Most Effective Collection Methods?" },
  { id: "text-vs-video", label: "Do You Choose Between Text and Video Testimonials?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Testimonials reduce perceived risk by providing third-party validation from real customers — making them one of the highest-impact <Link to="/resources/social-proof/what-is-social-proof/" className="text-primary font-semibold hover:underline">social proof</Link> elements you can add to your website, with studies showing a 34% average conversion increase.</strong></p>
          ...
          <p className="text-foreground"><strong>Ask for testimonials at "peak happiness" moments — immediately after a customer achieves a measurable win, completes onboarding successfully, renews their subscription, or gives you positive feedback through another channel.</strong></p>
          ...
          <h2 id="what-to-ask" className="text-2xl font-bold mt-12">What Questions Do You Ask?</h2>
          <p className="text-foreground"><strong>Guide testimonials with specific questions that produce story-driven responses: ask about the problem they faced before, the specific results they achieved, and what they would tell someone considering your product.</strong></p>
          ...
          <p className="text-foreground"><strong>The most effective methods are email requests with embedded forms, dedicated collection landing pages, in-app prompts at milestone moments, and interview-style sessions for premium testimonials.</strong></p>
          ...
          <p className="text-foreground"><strong>Automate collection by triggering testimonial requests based on customer events (purchases, milestones, positive support interactions) through integrated workflows that send personalized requests at the optimal moment.</strong></p>
          ...
          <p className="text-foreground"><strong>Always obtain explicit written permission before publishing testimonials — include consent checkboxes in your collection form covering usage rights for website, marketing materials, and social media, with the option for the customer to remain anonymous.</strong></p>
          <p className="text-muted-foreground">Your testimonial collection form must include a clear consent statement: "I give [Company Name] permission to use my name, title, company, and testimonial on their website and marketing materials." This protects you legally and builds trust with the customer who understands exactly how their words will be used.</p>
          ...
          <p className="text-foreground"><strong>High-quality testimonials include specific metrics, name the problem solved, identify the customer by name and role, and follow a before-after narrative. Achieve this by asking guided questions and providing examples of what "great" looks like.</strong></p>
