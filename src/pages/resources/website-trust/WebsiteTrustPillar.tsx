...
const tocSections = [
  { id: "trust-problem", label: "The Online Trust Problem" },
  { id: "trust-signals", label: "The 7 Types of Website Trust Signals" },
  { id: "visual-credibility", label: "Visual Design and Credibility" },
  { id: "social-proof-trust", label: "Social Proof as a Trust Accelerator" },
  { id: "trust-badges", label: "Trust Badges and Security Signals" },
  { id: "content-trust", label: "Content-Based Trust Building" },
  { id: "trust-by-business", label: "Trust Strategies by Business Type" },
  { id: "measuring-trust", label: "Measuring Trust Impact" },
  { id: "trust-mistakes", label: "Trust-Killing Mistakes to Avoid" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <h2 id="trust-problem" className="text-2xl font-bold mt-12">The Online Trust Problem</h2>
          ...
          <h2 id="trust-signals" className="text-2xl font-bold mt-12">The 7 Types of Website Trust Signals</h2>
          ...
          <h2 id="visual-credibility" className="text-2xl font-bold mt-12">Visual Design and Credibility</h2>
          ...
          <h2 id="social-proof-trust" className="text-2xl font-bold mt-12">Social Proof as a Trust Accelerator</h2>
          ...
          <h2 id="trust-badges" className="text-2xl font-bold mt-12">Trust Badges and Security Signals</h2>
          ...
          <h2 id="content-trust" className="text-2xl font-bold mt-12">Content-Based Trust Building</h2>
          ...
          <h2 id="trust-by-business" className="text-2xl font-bold mt-12">Trust Strategies by Business Type</h2>
          ...
          <h2 id="measuring-trust" className="text-2xl font-bold mt-12">Measuring Trust Impact</h2>
          ...
          <h2 id="trust-mistakes" className="text-2xl font-bold mt-12">Trust-Killing Mistakes to Avoid</h2>
