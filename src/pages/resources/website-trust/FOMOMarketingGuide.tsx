    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>FOMO marketing leverages the psychological fear of missing out on valuable opportunities — using scarcity signals, urgency cues, and social proof of others' actions to motivate faster purchase decisions.</strong></p>
          ...
          <p className="text-foreground"><strong>FOMO activates three cognitive biases simultaneously: loss aversion (fear of losing the opportunity), <Link to="/resources/social-proof/social-proof-psychology/" className="text-primary font-semibold hover:underline">social proof</Link> (others are taking action, so I must too), and scarcity bias (limited availability increases perceived value).</strong></p>
          ...
          <p className="text-muted-foreground"><strong className="text-foreground">Scarcity principle:</strong> <dfn>Robert Cialdini</dfn>'s — an American psychologist and professor of marketing — research demonstrated that limited availability increases perceived value. A product that's "almost sold out" feels more valuable than the same product with unlimited availability — even though the product itself hasn't changed.</p>

          <h2 id="ethical-vs-manipulative" className="text-2xl font-bold mt-12">What's the Line Between Ethical and Manipulative?</h2>
          <p className="text-foreground"><strong>The ethical line is truthfulness: real scarcity (actual limited stock) is ethical; fake scarcity (manufactured countdown timers that reset) is manipulative. Real social proof (actual purchase data) is ethical; fake notifications (fabricated activity) is manipulative.</strong></p>
          ...
          <p className="text-foreground"><strong>The most effective ethical FOMO techniques are real-time purchase notifications (10-35% conversion lift), genuine low-stock alerts (14% conversion increase), time-limited offers with real deadlines (9% lift), and live visitor counts (8-18% lift).</strong></p>
          ...
          <p className="text-foreground"><strong><Link to="/product/social-proof-notifications/" className="text-primary font-semibold hover:underline">Real-time notifications</Link> create FOMO by making invisible buyer activity visible — transforming your website from a silent storefront into a visibly busy marketplace where other people are actively making purchases.</strong></p>
