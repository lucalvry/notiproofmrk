...
const tocSections = [
  ...
  { id: "placement", label: "Where Should You Place Trust Badges?" },
  ...
  { id: "custom-badges", label: "Should You Create Custom Trust Badges?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="font-medium text-foreground">The most conversion-influential badges are those that directly address the visitor's primary concern at each page position — security badges near payment forms, satisfaction guarantees near buy buttons, and review badges near product descriptions.</p>
          ...
          <h2 id="placement" className="text-2xl font-bold mt-12">Where Should You Place Trust Badges?</h2>
          <p className="font-medium text-foreground">Place security badges adjacent to payment forms, guarantee badges near the buy/CTA button, review/rating badges near product descriptions, and a trust bar with multiple badges in the site footer — matching the badge type to the trust concern at each position.</p>
          ...
          <p className="font-medium text-foreground">Norton/Symantec, McAfee Secure, and PCI DSS compliance badges are the most widely recognized security indicators — with Norton leading at 35.6% recognition according to CXL research.</p>
          ...
          <p className="font-medium text-foreground">Yes — displaying accepted payment method logos (Visa, Mastercard, PayPal, Apple Pay, Google Pay) increases checkout conversion by 5-10% because they signal both security and convenience simultaneously.</p>
