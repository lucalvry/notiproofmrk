...
const tocSections = [
  ...
  { id: "why-aggregate", label: "Why Aggregate Reviews?" },
  { id: "which-platforms", label: "Which Review Platforms Do You Aggregate?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Review aggregation is the process of collecting customer reviews from multiple third-party platforms and consolidating them into a single, unified display on your own website or marketing materials.</strong></p>
          ...
          <h2 id="why-aggregate" className="text-2xl font-bold mt-12">Why Aggregate Reviews?</h2>
          <p className="text-foreground"><strong>Aggregating reviews increases your total visible review count, combines trust signals from recognized platforms, and ensures visitors see your full reputation without leaving your website.</strong></p>
          ...
          <h2 id="which-platforms" className="text-2xl font-bold mt-12">Which Review Platforms Do You Aggregate?</h2>
          <p className="text-foreground"><strong>Prioritize the platforms where your customers actively leave reviews: Google Business Profile for local businesses, G2/Capterra for SaaS, Trustpilot for e-commerce, and industry-specific directories for niche businesses.</strong></p>
          ...
          <p className="text-muted-foreground"><strong className="text-foreground">Facebook Recommendations:</strong> While less formal than dedicated review platforms, Facebook reviews reach your social audience. Businesses with strong Facebook communities must include these in their aggregation.</p>
          ...
          <p className="text-foreground"><strong>Manual aggregation (copying and pasting reviews) is unsustainable beyond 20-30 reviews because reviews go stale, new reviews are missed, and the maintenance burden grows. Automated aggregation through API connections ensures real-time freshness with zero ongoing effort.</strong></p>
          ...
          <p className="text-foreground"><strong>Implementation requires three steps: connect your review platform accounts, configure display preferences and filters, and embed the aggregated widget on your key conversion pages.</strong></p>
          ...
          <p className="text-foreground"><strong>JSON-LD AggregateRating schema markup on your aggregated reviews enables rich snippet stars in Google search results — increasing organic click-through rates by 20-35% on average.</strong></p>
          ...
          <p className="text-foreground"><strong>The most effective display strategy combines a summary bar (aggregate rating + total count + platform logos) above the fold with a scrollable review feed lower on the page — providing instant credibility at the top and depth for visitors who want to read individual reviews.</strong></p>
          ...
          <p className="text-foreground"><strong>Maintain freshness by setting automatic sync schedules, continuing to actively collect new reviews, and periodically auditing your display to ensure the most recent, relevant reviews are prominently featured.</strong></p>
