    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Track four key metrics: review request-to-completion rate (target: 15-25%), monthly review velocity (new reviews per month), average star rating trend (must stay stable or improve), and review-influenced conversion rate (tracked via A/B testing review displays).</strong></p>
