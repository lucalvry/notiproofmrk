    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>G2 dominates mid-market and enterprise software evaluation, while Capterra drives more SMB traffic — most B2B companies must maintain active profiles on both, but prioritize G2 for enterprise pipeline and Capterra for SMB lead generation.</strong></p>
