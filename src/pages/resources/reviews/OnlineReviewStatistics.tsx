    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-muted-foreground"><strong className="text-foreground">First review impact:</strong> The conversion lift from 0 reviews to 1 review is the largest: 52.2% for lower-priced products and up to 380% for higher-priced products (Spiegel). This means getting your first reviews on every product or service page should be your highest priority.</p>
