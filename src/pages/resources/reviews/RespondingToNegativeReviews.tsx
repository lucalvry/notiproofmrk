...
const tocSections = [
  ...
  { id: "response-templates", label: "What Response Templates Should You Use?" },
  { id: "timing", label: "How Quickly Should You Respond?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="font-medium text-foreground">Use the HEARD framework: Hear the customer, Empathize with their frustration, Apologize sincerely, Resolve the issue (or offer to), and Diagnose what went wrong to prevent recurrence.</p>
          ...
          <h2 id="response-templates" className="text-2xl font-bold mt-12">What Response Templates Should You Use?</h2>
          <p className="font-medium text-foreground">Customize these templates for common scenarios — never copy-paste identical responses, as duplicate responses appear automated and insincere to readers.</p>
          ...
          <h2 id="timing" className="text-2xl font-bold mt-12">How Quickly Should You Respond?</h2>
          <p className="font-medium text-foreground">Respond within 24-48 hours for negative reviews, and within 24 hours if the review mentions an urgent or safety-related issue. Faster responses demonstrate attentiveness and can de-escalate situations before they spread.</p>
          ...
          <p className="font-medium text-foreground">Each scenario requires a tailored approach: legitimate complaints need empathy and resolution, misunderstandings need clarification without condescension, and competitor attacks need factual, professional responses.</p>
          ...
          <p className="font-medium text-foreground">Yes — a mix of positive and negative reviews (maintaining a 4.2-4.7 average) actually increases trust and conversion rates compared to a perfect 5.0, because consumers perceive imperfect ratings as more authentic and honest.</p>
          ...
          <p className="font-medium text-foreground">Flag fake reviews through the platform's reporting system, respond professionally noting that you have no record of the transaction, and document evidence for the platform's review team — but never publicly accuse the reviewer of lying.</p>
          ...
          <p className="font-medium text-foreground">Prevent negative reviews by proactively collecting feedback through private channels first, resolving issues before they escalate to public platforms, and creating easy internal escalation paths for unhappy customers.</p>
