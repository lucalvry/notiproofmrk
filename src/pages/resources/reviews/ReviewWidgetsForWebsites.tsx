    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-muted-foreground">The <Link to="/resources/social-proof/social-proof-psychology/" className="text-primary font-semibold hover:underline">psychology</Link> is clear: reviews reduce perceived risk. When placed near conversion points (buy buttons, signup forms, contact forms), they answer the visitor's trust question exactly when it matters most. E-commerce pages with embedded reviews see 15-35% higher conversion rates than identical pages without them.</p>
          ...
          <p className="text-muted-foreground"><strong className="text-foreground">Filtering and moderation:</strong> Ability to set minimum ratings, filter by keyword or recency, and hide specific reviews. Never hide all negative reviews (it looks suspicious), but moderation control matters for removing irrelevant or outdated content.</p>
