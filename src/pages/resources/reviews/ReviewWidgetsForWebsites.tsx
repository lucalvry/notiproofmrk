...
const tocSections = [
  ...
  { id: "why-use-widgets", label: "Why Should You Embed Review Widgets?" },
  { id: "types-of-widgets", label: "What Types of Review Widgets Are Available?" },
  { id: "features-to-look-for", label: "What Features Should You Look For?" },
  { id: "placement", label: "Where Should You Place Review Widgets?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <h2 id="why-use-widgets" className="text-2xl font-bold mt-12">Why Should You Embed Review Widgets?</h2>
          <p className="font-medium text-foreground">Embedding review widgets keeps visitors on your site during the evaluation phase, increases conversion rates by 15-35%, and enables rich snippet eligibility in Google search results through structured data markup.</p>
          ...
          <p className="font-medium text-foreground">The five primary widget formats are grid, carousel, masonry wall, list, and badge — each suited to different page types, content volumes, and design requirements.</p>
          ...
          <h2 id="features-to-look-for" className="text-2xl font-bold mt-12">What Features Should You Look For?</h2>
          <p className="font-medium text-foreground">Essential features include multi-platform aggregation, automatic syncing, JSON-LD schema markup, responsive design, performance optimization (lazy loading), and visual customization to match your brand.</p>
          ...
          <h2 id="placement" className="text-2xl font-bold mt-12">Where Should You Place Review Widgets?</h2>
          <p className="font-medium text-foreground">Place review widgets at decision points: on the homepage below the hero, on product pages near the buy button, on pricing pages near plan comparisons, on landing pages near CTAs, and on a dedicated testimonials page for deep evaluation.</p>
          ...
          <p className="font-medium text-foreground">Review widgets with proper JSON-LD schema markup enable rich snippet stars in Google search results — increasing organic click-through rates by 20-35% and driving more qualified traffic to your pages.</p>
          ...
          <p className="font-medium text-foreground">Poorly built widgets can add 500ms-2s to page load time, impacting Core Web Vitals and conversions. Well-optimized widgets use lazy loading, async scripts, and CDN delivery to add less than 100ms of overhead.</p>
          ...
          <p className="font-medium text-foreground">Choose based on four criteria: platform compatibility (does it connect to your review sources?), customization depth (can it match your brand?), SEO capabilities (does it include schema?), and performance impact (how much does it add to page load?).</p>
