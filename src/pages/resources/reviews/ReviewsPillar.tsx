...
const tocSections = [
  ...
  { id: "review-platforms", label: "Which Review Platforms Do You Use?" },
  ...
  { id: "negative-reviews", label: "How Do You Handle Negative Reviews?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Reviews matter because 93% of consumers say they influence purchasing decisions — they provide psychological validation and practical information simultaneously, making them the most persuasive form of social proof.</strong></p>
          ...
          <p className="text-muted-foreground">The trust dynamic is simple — when a potential customer reads that someone in a similar situation had a positive experience, it reduces perceived risk and accelerates the decision. <dfn>BrightLocal</dfn> — a local SEO and reputation management research firm — found in their 2024 Consumer Review Survey that 87% of consumers read online reviews for local businesses, up from 67% in 2010. For e-commerce, the numbers are even higher.</p>
          <p className="text-muted-foreground">Beyond conversion optimization, reviews create a virtuous cycle: more reviews attract more visitors through SEO, which generates more customers, who leave more reviews. A Harvard Business School study found that a one-star increase in Yelp rating leads to a 5–9% increase in revenue. Reviews also reduce customer acquisition costs — when potential buyers can read authentic experiences from real customers, they need fewer touchpoints before converting, shortening the sales cycle and reducing paid advertising spend.</p>

          <h2 id="review-landscape" className="text-2xl font-bold mt-12">What Does the Modern Review Landscape Look Like?</h2>
          <p className="text-foreground"><strong>Today's reviews are fragmented across dozens of platforms — Google, Yelp, Trustpilot, G2 — creating both a visibility challenge and an aggregation opportunity for savvy businesses.</strong></p>
          ...
          <p className="text-foreground"><strong>The most effective strategy is asking at the right moment — immediately after a positive experience — using automated post-purchase emails, in-app prompts, and frictionless review forms.</strong></p>
          ...
          <p className="text-foreground"><strong>Focus on 2–3 platforms where your audience actively searches — Google Business Profile for local, Trustpilot for e-commerce, G2/Capterra for B2B SaaS — then aggregate all reviews on your website.</strong></p>
          ...
          <p className="text-foreground"><strong>Effective aggregation pulls reviews from multiple platforms into a single display on your website, showing a combined score like "4.8/5 from 2,847 reviews across Google, Trustpilot, and G2" for maximum credibility.</strong></p>
          ...
          <h2 id="negative-reviews" className="text-2xl font-bold mt-12">How Do You Handle Negative Reviews?</h2>
          <p className="text-foreground"><strong>Respond quickly and professionally, use feedback as product insight, and never delete legitimate reviews — a perfect 5.0 actually reduces trust, while the ideal range of 4.2–4.8 signals authentic quality.</strong></p>
          ...
          <p className="text-foreground"><strong>Reviews boost SEO through rich snippets (15–30% CTR increase), fresh user-generated content, natural long-tail keywords, and direct local ranking improvements via Google Business Profile.</strong></p>
          ...
          <p className="text-foreground"><strong>Track review widget engagement, conversion rate by review exposure, review-to-conversion attribution, collection rate (benchmark 5–15%), and average rating trends over time.</strong></p>
