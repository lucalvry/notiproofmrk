...
const tocSections = [
  { id: "why-reviews-matter", label: "Why Customer Reviews Matter" },
  { id: "review-landscape", label: "The Modern Review Landscape" },
  { id: "collecting-reviews", label: "How to Collect More Reviews" },
  { id: "review-platforms", label: "Review Platforms Compared" },
  { id: "aggregation-strategy", label: "Review Aggregation Strategy" },
  { id: "displaying-reviews", label: "Displaying Reviews for Maximum Impact" },
  { id: "negative-reviews", label: "Handling Negative Reviews" },
  { id: "review-seo", label: "Reviews and SEO" },
  { id: "measuring-impact", label: "Measuring Review Impact" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <h2 id="why-reviews-matter" className="text-2xl font-bold mt-12">Why Customer Reviews Matter</h2>
          ...
          <h2 id="review-landscape" className="text-2xl font-bold mt-12">The Modern Review Landscape</h2>
          ...
          <h2 id="collecting-reviews" className="text-2xl font-bold mt-12">How to Collect More Reviews</h2>
          ...
          <h2 id="review-platforms" className="text-2xl font-bold mt-12">Review Platforms Compared</h2>
          ...
          <h2 id="aggregation-strategy" className="text-2xl font-bold mt-12">Review Aggregation Strategy</h2>
          ...
          <h2 id="displaying-reviews" className="text-2xl font-bold mt-12">Displaying Reviews for Maximum Impact</h2>
          ...
          <h2 id="negative-reviews" className="text-2xl font-bold mt-12">Handling Negative Reviews</h2>
          ...
          <h2 id="review-seo" className="text-2xl font-bold mt-12">Reviews and SEO</h2>
          ...
          <h2 id="measuring-impact" className="text-2xl font-bold mt-12">Measuring Review Impact</h2>
