...
const tocSections = [
  ...
  { id: "common-mistakes", label: "What Mistakes Do You Avoid When Collecting Reviews?" },
  { id: "display-reviews", label: "How Do You Display Google Reviews on Your Website?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Google reviews directly impact your local search ranking, click-through rate, and conversion rate — making them one of the highest-ROI marketing activities for any local or online business.</strong></p>
          ...
          <p className="text-foreground"><strong>Most businesses need a minimum of 10-20 reviews to establish basic credibility, but competitive industries require 50-100+ reviews with a consistent monthly velocity to rank in the local pack.</strong></p>
          ...
          <p className="text-foreground"><strong>The optimal time to request a review is within 24 hours of a positive customer experience — ideally immediately after the customer receives value from your product or service.</strong></p>
          ...
          <p className="text-foreground"><strong>The most effective review collection methods combine direct ask emails, SMS follow-ups, in-person requests, and strategically placed QR codes — each targeting a different customer touchpoint.</strong></p>
          ...
          <p className="text-foreground"><strong>You can create a direct Google review link using your Place ID, which opens Google's review form pre-loaded for your business — reducing friction from 5 clicks to 1.</strong></p>
          ...
          <p className="text-foreground"><strong>The highest-converting review request emails are short (under 80 words), personalized with the customer's name and purchase details, and include a single prominent CTA button linking directly to the review form.</strong></p>
          ...
          <h2 id="common-mistakes" className="text-2xl font-bold mt-12">What Mistakes Do You Avoid When Collecting Reviews?</h2>
          <p className="text-foreground"><strong>The biggest mistakes are offering incentives for reviews (violates Google policy), review-gating (filtering out negative reviewers), sending bulk requests to old customers, and not responding to reviews you receive.</strong></p>
          ...
          <h2 id="display-reviews" className="text-2xl font-bold mt-12">How Do You Display Google Reviews on Your Website?</h2>
          <p className="text-foreground"><strong>Display Google reviews prominently on your homepage, product/service pages, and landing pages using a widget that automatically syncs new reviews and includes schema markup for rich snippets.</strong></p>
          ...
          <p className="text-foreground"><strong>Respond to every negative review within 24-48 hours with empathy, take the conversation offline to resolve the issue, and never argue publicly — a professional response can turn a negative review into a trust-building opportunity.</strong></p>
