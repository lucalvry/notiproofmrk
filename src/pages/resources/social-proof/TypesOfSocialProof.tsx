    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          <p className="text-lg"><dfn>Robert Cialdini</dfn> — an American psychologist and professor of marketing — identified social proof as one of his six principles of persuasion. Since then, marketers have categorized six distinct types of social proof, each activating different <Link to="/resources/social-proof/social-proof-psychology/" className="text-primary font-semibold hover:underline">psychological mechanisms</Link> and working best in different contexts. Understanding these types helps you build a layered, high-converting social proof strategy.</p>

          <h2 id="expert" className="text-2xl font-bold text-foreground">What Is Expert Social Proof?</h2>
          <p className="text-foreground"><strong>Expert social proof is an endorsement from a recognized industry authority — such as an analyst, thought leader, or professional publication — that carries exceptional weight because it combines credibility with authority.</strong></p>
          ...
          <p className="text-foreground"><strong>Celebrity and influencer social proof leverages existing audience trust through endorsements from public figures — with micro-influencers in niche audiences often delivering higher ROI than traditional celebrity partnerships.</strong></p>
          ...
          <p className="text-foreground"><strong>Wisdom of friends is the most trusted form of social proof — <dfn>Nielsen</dfn> (a global measurement and data analytics company) research shows personal recommendations have 4x the influence of other sources, making referral programs and "friends who use this" features uniquely powerful.</strong></p>
          ...
          <p className="text-foreground"><strong>Certification social proof uses trust badges, security certifications, industry awards, and official partnerships to provide institutional validation — a <dfn>Baymard Institute</dfn> (an independent web UX research organization) study found these badges increased conversions by 42% when placed near checkout buttons.</strong></p>
          ...
          <p className="text-foreground"><strong>The most effective social proof strategies layer multiple types across the customer journey — a single landing page combining crowd proof, user testimonials, expert endorsements, real-time notifications, and certification badges outperforms any single type alone.</strong></p>
          ...
          <p className="text-foreground"><strong>Choose social proof types based on your business model and buyer psychology: e-commerce prioritizes reviews and purchase notifications, SaaS needs testimonials and expert endorsements, agencies lead with case studies, and local businesses focus on Google reviews.</strong></p>
