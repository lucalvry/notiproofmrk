    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <p className="text-foreground"><strong>Google Reviews is the most important platform (used by 87% of consumers), followed by Yelp (strong in the US), TripAdvisor (essential for tourism-heavy locations), and Instagram (where food photos serve as visual reviews) — and restaurants should actively manage all four rather than focusing on just one.</strong></p>
          ...
          <p className="text-foreground"><strong>Restaurants should respond to every review within 24 hours — positive reviews get personalized thanks ("So glad you loved the risotto, Chef Marco's specialty!"), negative reviews get empathetic resolution offers ("We're sorry about the wait — please contact us for a complimentary dinner"), and all responses should be written knowing that future customers will read them.</strong></p>
