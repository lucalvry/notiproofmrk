...
const tocSections = [
  ...
  { id: "mistakes", label: "What Social Proof Mistakes Do You Avoid?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="text-foreground"><strong>Social proof is the psychological principle where people follow others' actions to guide their own decisions — first described by Robert Cialdini in 1984, it now drives 10–35% conversion lifts on websites through reviews, notifications, and trust signals.</strong></p>
          <p className="text-muted-foreground">Social proof is a psychological principle first described by <dfn>Robert Cialdini</dfn> — an American psychologist and professor of marketing — in his 1984 book <em>Influence: The Psychology of Persuasion</em>. It describes our tendency to assume that the actions of others reflect the correct behavior in a given situation. This instinct evolved as a survival mechanism: early humans who followed the group's behavior were more likely to survive, and the same pattern persists in modern decision-making — when you see a crowded restaurant versus an empty one, you instinctively assume the crowded one serves better food.</p>
          <p className="text-muted-foreground">In digital marketing, social proof manifests as customer testimonials, review ratings, purchase notifications, visitor counts, case studies, social media follower counts, and trust badges. These trust signals reduce perceived risk and increase confidence in purchasing decisions — according to Nielsen research, 92% of consumers trust peer recommendations over traditional advertising. <Link to="/product/social-proof-notifications/" className="text-primary font-semibold hover:underline">Real-time social proof notifications</Link> showing recent purchases, signups, and reviews create immediate trust signals that accelerate buying decisions. Learn more in our detailed guide: <Link to="/resources/social-proof/what-is-social-proof/" className="text-primary font-semibold hover:underline">What Is Social Proof? →</Link></p>

          <h2 id="types-of-social-proof" className="text-2xl font-bold mt-12">What Are the 6 Types of Social Proof?</h2>
          <p className="text-foreground"><strong>The six types are expert, celebrity, user, crowd wisdom, friend recommendations, and certification — each activating different psychological triggers and working best at different stages of the buyer journey.</strong></p>
          ...
          <p className="text-foreground"><strong>Social proof works because of deeply ingrained cognitive biases — the bandwagon effect, informational social influence, and FOMO — that evolved as survival mechanisms and now drive modern purchasing decisions.</strong></p>
          <p className="text-muted-foreground"><strong className="text-foreground">The Bandwagon Effect:</strong> People adopt behaviors and beliefs because others are doing the same. In marketing, customers choose popular products over alternatives because popularity signals quality and safety. <Link to="/product/recent-activity-notifications/" className="text-primary font-semibold hover:underline">Recent activity notifications</Link> showing a stream of signups or purchases directly activate this bias.</p>
          ...
          <p className="text-foreground"><strong>Deploy social proof strategically at every funnel stage: press mentions for awareness, testimonials for consideration, purchase notifications for decision, and community activity for retention.</strong></p>
          ...
          <p className="text-foreground"><strong>Amazon, Booking.com, and Basecamp are among the best examples — each layering multiple social proof types (reviews, live activity, crowd counts) to minimize uncertainty and maximize conversions.</strong></p>
          ...
          <p className="text-foreground"><strong>Track conversion rate, average order value, time to purchase, notification engagement, and revenue attribution before and after implementation — NotiProof's analytics dashboard measures all of these automatically.</strong></p>
          ...
          <h2 id="mistakes" className="text-2xl font-bold mt-12">What Social Proof Mistakes Do You Avoid?</h2>
          <p className="text-foreground"><strong>The biggest mistakes are using fake data, placing proof where nobody sees it, letting testimonials go stale, and overwhelming visitors with too many signals at once.</strong></p>
