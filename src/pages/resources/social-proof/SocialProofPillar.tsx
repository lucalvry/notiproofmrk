...
const tocSections = [
  ...
  { id: "types-of-social-proof", label: "The 6 Types of Social Proof" },
  { id: "psychology", label: "The Psychology Behind Social Proof" },
  { id: "statistics-2025", label: "Social Proof Statistics (2025)" },
  { id: "marketing", label: "Social Proof in Marketing" },
  { id: "implementation", label: "How to Add Social Proof to Your Website" },
  { id: "examples", label: "Real-World Social Proof Examples" },
  { id: "measuring-roi", label: "How to Measure Social Proof ROI" },
  { id: "mistakes", label: "Common Social Proof Mistakes to Avoid" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <h2 id="types-of-social-proof" className="text-2xl font-bold mt-12">The 6 Types of Social Proof</h2>
          ...
          <h2 id="psychology" className="text-2xl font-bold mt-12">The Psychology Behind Social Proof</h2>
          ...
          <h2 id="statistics-2025" className="text-2xl font-bold mt-12">Social Proof Statistics (2025)</h2>
          ...
          <h2 id="marketing" className="text-2xl font-bold mt-12">Social Proof in Marketing</h2>
          ...
          <h2 id="implementation" className="text-2xl font-bold mt-12">How to Add Social Proof to Your Website</h2>
          ...
          <h2 id="examples" className="text-2xl font-bold mt-12">Real-World Social Proof Examples</h2>
          ...
          <h2 id="measuring-roi" className="text-2xl font-bold mt-12">How to Measure Social Proof ROI</h2>
          ...
          <h2 id="mistakes" className="text-2xl font-bold mt-12">Common Social Proof Mistakes to Avoid</h2>
