...
const tocSections = [
  { id: "ecommerce-examples", label: "What Are the Best E-commerce Social Proof Examples?" },
  { id: "saas-examples", label: "How Do Top SaaS Companies Use Social Proof?" },
  { id: "realtime-examples", label: "What Do Effective Real-Time Notification Examples Look Like?" },
  { id: "testimonial-examples", label: "What Makes a Great Testimonial or Review Example?" },
  { id: "scarcity-examples", label: "How Do Brands Use Scarcity and Urgency Ethically?" },
  { id: "b2b-examples", label: "What Are the Best B2B Social Proof Examples?" },
  { id: "how-to-apply", label: "How Do You Apply These Examples to Your Business?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          <p className="text-lg">The best way to understand social proof is to see it in action. Here are real examples from companies that use social proof masterfully to increase <dfn><Link to="/resources/glossary/#conversion-rate" className="text-primary font-semibold hover:underline">conversions</Link></dfn>, build <Link to="/resources/website-trust/" className="text-primary font-semibold hover:underline">website trust</Link>, and drive revenue. Each example includes an analysis of why it works and how you can apply the same principle.</p>

          <h2 id="ecommerce-examples" className="text-2xl font-bold text-foreground">What Are the Best E-commerce Social Proof Examples?</h2>
          <p className="text-foreground"><strong>Amazon and Booking.com are the gold standard for e-commerce social proof — Amazon layers 4-5 types per page (reviews, badges, recommendations, verified labels), while Booking.com combines live activity with FOMO signals to achieve industry-leading conversion rates.</strong></p>
          ...
          <h2 id="saas-examples" className="text-2xl font-bold text-foreground">How Do Top SaaS Companies Use Social Proof?</h2>
          <p className="text-foreground"><strong>Leading SaaS companies like Basecamp, Slack, and Notion use specific user counts, named customer logos organized by company size, and statistical claims — succeeding because their social proof is specific and addresses the "is this for me?" objection.</strong></p>
          ...
          <h2 id="realtime-examples" className="text-2xl font-bold text-foreground">What Do Effective Real-Time Notification Examples Look Like?</h2>
          <p className="text-foreground"><strong>Effective real-time social proof notifications combine specificity (name, location), recency ("just purchased"), and variety (purchases, signups, reviews, live visitor counts) — creating a living sense of momentum that static testimonial pages cannot match.</strong></p>
          ...
          <h2 id="testimonial-examples" className="text-2xl font-bold text-foreground">What Makes a Great Testimonial or Review Example?</h2>
          <p className="text-foreground"><strong>The best testimonial examples include specific metrics ("From $0 to $1M in 18 months"), the customer's photo and company name for relatability, and use video format when possible — which is 5-7x more engaging than text and harder to fake.</strong></p>
          ...
          <h2 id="scarcity-examples" className="text-2xl font-bold text-foreground">How Do Brands Use Scarcity and Urgency Ethically?</h2>
          <p className="text-foreground"><strong>Ethical scarcity combines genuine stock data or time limits with social proof — like "847 people have already claimed this deal" alongside a real countdown, or Amazon's "Only 3 left — 14 people have this in their cart" connected to actual inventory data.</strong></p>
          ...
          <h2 id="b2b-examples" className="text-2xl font-bold text-foreground">What Are the Best B2B Social Proof Examples?</h2>
          <p className="text-foreground"><strong>HubSpot and Salesforce lead B2B social proof with industry-organized customer logos, specific ROI metrics ("37% increase in sales productivity"), and large aggregate numbers — providing the internal justification ammunition that B2B buyers need.</strong></p>
          ...
          <h2 id="how-to-apply" className="text-2xl font-bold text-foreground">How Do You Apply These Examples to Your Business?</h2>
          <p className="text-foreground"><strong>Start by matching social proof types to your business model and customer journey, then implement with NotiProof — from <Link to="/product/social-proof-notifications/" className="text-primary font-semibold hover:underline">real-time notifications</Link> to <Link to="/product/testimonials-collection-text-image-video/" className="text-primary font-semibold hover:underline">testimonial collection</Link> — and optimize based on A/B test data.</strong></p>
