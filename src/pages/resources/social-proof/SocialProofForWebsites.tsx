...
const tocSections = [
  ...
  { id: "placement", label: "Where Do You Place Social Proof on Your Website?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <p className="text-foreground"><strong>Choose social proof types based on your business model: e-commerce stores need purchase notifications and reviews, SaaS products need signup activity and ROI testimonials, service businesses need booking notifications, and local businesses need Google review aggregation.</strong></p>
          ...
          <h2 id="placement" className="text-2xl font-bold text-foreground">Where Do You Place Social Proof on Your Website?</h2>
          <p className="text-foreground"><strong>Place social proof where decisions happen — next to CTAs, on pricing pages, and during checkout — because Baymard Institute research shows placement is as important as the proof itself, with proximity to conversion points directly impacting effectiveness.</strong></p>
          ...
          <p className="text-foreground"><strong>With NotiProof, adding social proof takes 60 seconds on any platform: add one JavaScript tag, configure notification types and styling in the dashboard, set display rules, and go live — no development work required.</strong></p>
          ...
          <p className="text-foreground"><strong>Continuously A/B test notification designs, message copy, display frequency, and placement — small changes in color, position, or wording can yield significant conversion lifts when measured with NotiProof's built-in analytics.</strong></p>
          ...
          <p className="text-foreground"><strong>Effective homepage social proof includes a "Trusted by X,000+ businesses" bar with customer logos in the hero, 2-3 customer testimonials with specific results below the fold, and real-time activity notifications creating momentum throughout.</strong></p>
          ...
          <p className="text-foreground"><strong>Product pages need aggregated star ratings near the title, customer photos and testimonial widgets below the description, live purchase notifications ("X people bought this in 24 hours"), and visitor counters — all placed near the buy button for maximum impact.</strong></p>
          ...
          <p className="text-foreground"><strong>Cart abandonment averages 70% across e-commerce — the most effective checkout social proof includes security badges (SSL, payment logos), recent purchase notifications creating urgency, and brief testimonials addressing shipping or quality objections.</strong></p>
          ...
          <p className="text-foreground"><strong>NotiProof offers one-click installation for major platforms: Shopify app with automatic order sync, WordPress plugin with WooCommerce integration, Zapier connection for any data source, and a single script tag for custom HTML sites.</strong></p>
