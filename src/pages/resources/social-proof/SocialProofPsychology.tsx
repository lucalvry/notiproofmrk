    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <p className="font-medium text-foreground">Informational social influence is the tendency to look to others' actions for guidance when uncertain about a decision — which is why products with 4.8 stars and 2,000 reviews see 270% higher conversion rates for higher-priced items.</p>
          ...
          <p className="font-medium text-foreground">Herd mentality is an evolutionary survival instinct that causes humans to follow group behavior — which is why <Link to="/product/visitor-counter-live-visitors/" className="text-primary font-semibold hover:underline">live visitor counters</Link> showing "287 people browsing now" are especially effective for uncertain buyers in competitive markets.</p>
          ...
          <p className="font-medium text-foreground">Authority bias causes people to attribute greater accuracy to authority figures' opinions — making <Link to="/resources/social-proof/types-of-social-proof/" className="text-primary font-semibold hover:underline">expert social proof</Link> like "Recommended by [Industry Leader]" or "Featured in Forbes" dramatically more effective per individual signal than anonymous reviews.</p>
          ...
          <p className="font-medium text-foreground">Research from the Journal of Consumer Research shows social proof's effectiveness increases dramatically with buyer uncertainty — making it most impactful on pricing pages, checkout pages, and landing pages for new products where commitment anxiety peaks.</p>
          ...
          <p className="font-medium text-foreground">Ethical social proof uses real customer data, genuine testimonials, and actual activity metrics — because research consistently shows consumers detect and punish fake reviews, inflated numbers, and inauthentic endorsements with permanent brand damage.</p>
