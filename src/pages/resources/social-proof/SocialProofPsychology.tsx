...
const tocSections = [
  { id: "bandwagon", label: "What Is the Bandwagon Effect?" },
  { id: "informational", label: "What Is Informational Social Influence?" },
  { id: "fomo", label: "How Does Fear of Missing Out (FOMO) Drive Conversions?" },
  { id: "herd", label: "What Is the Herd Mentality?" },
  { id: "authority-bias", label: "How Does Authority Bias Amplify Social Proof?" },
  { id: "uncertainty", label: "Why Is Social Proof More Effective Under Uncertainty?" },
  { id: "applying", label: "How Do You Apply Social Proof Psychology Ethically?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <h2 id="bandwagon" className="text-2xl font-bold text-foreground">What Is the Bandwagon Effect?</h2>
          <p className="text-foreground"><strong>The <dfn><Link to="/resources/glossary/#bandwagon-effect" className="text-primary font-semibold hover:underline">bandwagon effect</Link></dfn> is the cognitive bias that causes people to adopt behaviors primarily because others are doing them — explaining why popular products become more popular and why phrases like "Join 10,000+ businesses" increase conversions.</strong></p>
          <p>First formally studied in the 1950s by psychologist Solomon Asch, this effect explains why popular products become more popular — success breeds success.</p>
          ...
          <h2 id="informational" className="text-2xl font-bold text-foreground">What Is Informational Social Influence?</h2>
          <p className="text-foreground"><strong>Informational social influence is the tendency to look to others' actions for guidance when uncertain about a decision — which is why products with 4.8 stars and 2,000 reviews see 270% higher conversion rates for higher-priced items.</strong></p>
          <p>When we're uncertain about a decision, we look to others for information about the correct course of action. We assume that others possess more knowledge about the situation than we do. In consumer behavior, this is why <Link to="/resources/reviews/" className="text-primary font-semibold hover:underline">online reviews</Link> are so powerful.</p>
          ...
          <h2 id="fomo" className="text-2xl font-bold text-foreground">How Does Fear of Missing Out (FOMO) Drive Conversions?</h2>
          <p className="text-foreground"><strong><dfn><Link to="/resources/glossary/#fomo" className="text-primary font-semibold hover:underline">FOMO</Link></dfn> activates loss aversion — the principle that people feel losses twice as intensely as equivalent gains — increasing impulsive purchasing by 60% when triggered by real-time notifications like "Sarah just purchased" or "Only 3 left in stock."</strong></p>
          ...
          <h2 id="herd" className="text-2xl font-bold text-foreground">What Is the Herd Mentality?</h2>
          <p className="text-foreground"><strong>Herd mentality is an evolutionary survival instinct that causes humans to follow group behavior — which is why <Link to="/product/visitor-counter-live-visitors/" className="text-primary font-semibold hover:underline">live visitor counters</Link> showing "287 people browsing now" are especially effective for uncertain buyers in competitive markets.</strong></p>
          ...
          <p>When visitors see that many people are engaging with your product, it triggers an ancient instinct that says "this must be safe and worthwhile." Live visitor counters tap directly into this instinct — showing real-time activity signals that the herd has already chosen your product.</p>
          ...
          <h2 id="authority-bias" className="text-2xl font-bold text-foreground">How Does Authority Bias Amplify Social Proof?</h2>
          <p className="text-foreground"><strong>Authority bias causes people to attribute greater accuracy to authority figures' opinions — making <Link to="/resources/social-proof/types-of-social-proof/" className="text-primary font-semibold hover:underline">expert social proof</Link> like "Recommended by [Industry Leader]" or "Featured in Forbes" dramatically more effective per individual signal than anonymous reviews.</strong></p>
          <p>When social proof comes from recognized experts, industry analysts, or authoritative publications, it carries significantly more weight than anonymous reviews.</p>
          <p>This is why expert social proof — "Recommended by [Industry Leader]" or "Featured in Forbes" — can move the conversion needle dramatically. It combines the trust-building power of social proof with the credibility of established authority.</p>
          ...
          <h2 id="uncertainty" className="text-2xl font-bold text-foreground">Why Is Social Proof More Effective Under Uncertainty?</h2>
          <p className="text-foreground"><strong>Research from the Journal of Consumer Research shows social proof's effectiveness increases dramatically with buyer uncertainty — making it most impactful on pricing pages, checkout pages, and landing pages for new products where commitment anxiety peaks.</strong></p>
          <p>The more uncertain a buyer feels, the more they rely on others' behavior to guide their decision.</p>
          ...
          <h2 id="applying" className="text-2xl font-bold text-foreground">How Do You Apply Social Proof Psychology Ethically?</h2>
          <p className="text-foreground"><strong>Ethical social proof uses real customer data, genuine testimonials, and actual activity metrics — because research consistently shows consumers detect and punish fake reviews, inflated numbers, and inauthentic endorsements with permanent brand damage.</strong></p>
