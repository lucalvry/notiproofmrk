    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <p>This is why Cialdini's <Link to="/resources/social-proof/types-of-social-proof/" className="text-primary font-semibold hover:underline">descriptive norms</Link> (what people actually do) are more powerful than injunctive norms (what people should do). "Most people recycle" beats "You should recycle" every time.</p>
