...
import featuredImg from "@/assets/featured-landing-page-optimization.jpg";
...
const tocSections = [
  ...
  { id: "social-proof-placement", label: "Where Do You Place Social Proof?" },
  ...
  { id: "testing", label: "What Do You A/B Test First?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <h2 id="social-proof-placement" className="text-2xl font-bold text-foreground">Where Do You Place Social Proof on Landing Pages?</h2>
          <p className="text-foreground"><strong>Place social proof in three critical zones: above the fold (logo bar or stat), next to the CTA (testimonial or review), and at the pricing section (case study or ROI metric) — each placement addresses different objections.</strong></p>
          ...
          <p className="text-foreground"><strong>Reduce friction by removing navigation links, minimizing form fields, adding progress indicators, displaying security badges, and ensuring page load time is under 3 seconds.</strong></p>
          ...
          <p className="text-foreground"><strong>Mobile optimization requires thumb-friendly CTAs, single-column layouts, compressed media, tap-to-call buttons, and mobile-specific social proof placement — mobile visitors convert 50% less than desktop on average.</strong></p>
          ...
          <h2 id="testing" className="text-2xl font-bold text-foreground">What Do You A/B Test First?</h2>
          <p className="text-foreground"><strong>Test in this order for maximum impact: 1) Headline, 2) CTA copy, 3) Social proof type/placement, 4) Form length, 5) Page layout — each of these independently drives 10–30% conversion differences.</strong></p>
