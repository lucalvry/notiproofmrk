...
const tocSections = [
  ...
  { id: "key-metrics", label: "Which CRO Metrics Should You Track?" },
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <p className="font-semibold text-foreground">CRO is the data-driven practice of improving your website's ability to convert visitors into customers — using research, testing, and iterative design changes to remove friction and increase motivation at every stage of the funnel.</p>
          ...
          <p className="text-muted-foreground">The conversion rate formula is straightforward: <strong className="text-foreground">Conversion Rate = (Number of Conversions ÷ Total Visitors) × 100</strong>. An e-commerce store with 50,000 monthly visitors and 1,500 purchases has a 3% conversion rate. If CRO efforts increase that to 4%, that's a 33% revenue increase with zero additional traffic spend.</p>
          <p className="text-muted-foreground">CRO is not guesswork or "best practices." It's a structured, evidence-based process that combines qualitative research (user interviews, session recordings, surveys) with quantitative testing (A/B tests, multivariate experiments) to identify what actually moves the needle for your specific audience.</p>

          <h2 id="why-cro-matters" className="text-2xl font-bold mt-12">Why Does CRO Matter More Than Traffic?</h2>
          <p className="font-semibold text-foreground">Doubling your conversion rate is equivalent to doubling your traffic — but costs a fraction of the price and compounds permanently, while paid traffic stops the moment you stop paying.</p>
          ...
          <p className="font-semibold text-foreground">The CRO process follows five stages: Research → Hypothesize → Prioritize → Test → Analyze — then repeat. The best teams run this cycle continuously, producing 3–5% monthly conversion improvements that compound into transformative annual growth.</p>
          ...
          <p className="text-muted-foreground"><strong className="text-foreground">3. Prioritize:</strong> Use an ICE framework (Impact × Confidence × Ease) to rank hypotheses. High-impact, high-confidence, easy-to-implement changes — like adding <Link to="/product/social-proof-notifications/" className="text-primary font-semibold hover:underline">social proof notifications</Link> — should always be tested first.</p>
          ...
          <h2 id="key-metrics" className="text-2xl font-bold mt-12">Which CRO Metrics Should You Track?</h2>
          <p className="font-semibold text-foreground">Focus on conversion rate, revenue per visitor, average order value, bounce rate, time to conversion, and micro-conversion rates — segmented by device, traffic source, and user type for actionable insights.</p>
          ...
          <p className="font-semibold text-foreground">Social proof is the single fastest CRO lever — it addresses both trust (reducing friction) and urgency (increasing motivation) simultaneously, delivering 10–35% conversion lifts with implementation times measured in minutes rather than months.</p>
          ...
          <p className="font-semibold text-foreground">Landing page optimization focuses on five elements: headline clarity, value proposition strength, social proof placement, CTA design, and friction reduction — each of which can be independently tested for maximum impact.</p>
          ...
          <p className="font-semibold text-foreground">The highest-ROI e-commerce CRO tactics are reducing cart abandonment with recovery notifications, adding social proof to product pages, optimizing the checkout flow, and implementing cross-sell/upsell displays.</p>
          ...
          <p className="font-semibold text-foreground">SaaS CRO focuses on three conversion points: visitor-to-trial (landing page optimization), trial-to-activation (onboarding optimization), and activation-to-paid (value demonstration and social proof during the trial period).</p>
          ...
          <p className="font-semibold text-foreground">Effective CRO testing requires statistical discipline: calculate sample size before launching, run tests for at least 2 full business cycles, test one variable at a time, and document every result — winners and losers alike.</p>
          ...
          <p className="font-semibold text-foreground">A complete CRO stack includes analytics (GA4 + NotiProof Analytics), qualitative research (heatmaps + session recordings), A/B testing, social proof (NotiProof), and form optimization tools.</p>
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li><strong className="text-foreground">Qualitative research:</strong> Hotjar or FullStory for <Link to="/resources/conversion-analytics/heatmap-analytics-guide/" className="text-primary font-semibold hover:underline">heatmaps and session recordings</Link></li>
