      ...
      content={
        <div className="space-y-8 text-foreground">
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li><strong className="text-foreground">2.6-second decision:</strong> Visitors form their first impression in 2.6 seconds. If they don't immediately understand what you offer and why they should care, they leave.</li>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
            <li><strong className="text-foreground">Headline (40% of above-fold impact):</strong> One sentence that answers "What is this, and why should I care?" Focus on the outcome, not the product.</li>
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            <li><strong className="text-foreground">Size = importance:</strong> The headline should be the largest text element. The CTA button should be the most visually prominent interactive element.</li>
            <li><strong className="text-foreground">Contrast:</strong> The CTA button should have the highest contrast on the page. If your background is light, use a saturated primary color button. If dark, use a bright accent.</li>
          ...
          <p className="text-foreground"><strong>Yes — but keep it compact. A logo strip, star rating, or customer count belongs above the fold. Full testimonials and review sections belong below the fold. The above-fold social proof signal should be one line that establishes credibility without competing with the headline and CTA.</strong></p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            <li><strong className="text-foreground">After value, before details:</strong> The CTA should come after the headline (what you get) and before the feature details (how it works). Visitors who are convinced by the headline can act immediately; others scroll for more info.</li>
          ...
          <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
            ...
            <li><strong className="text-foreground">Trust signal (should be above fold — keep to one line)</strong></li>
          ...
          <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
            ...
            <li>Headlines should follow "desired outcome + without pain point" formula</li>
