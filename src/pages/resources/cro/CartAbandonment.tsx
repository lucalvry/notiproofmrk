...
import featuredImg from "@/assets/featured-cart-abandonment.jpg";
    ...
    <ResourceArticle
      ...
      content={
        <div className="space-y-6 text-muted-foreground">
          ...
          <p className="text-foreground"><strong>The top five reasons for cart abandonment are unexpected costs (48%), forced account creation (24%), complex checkout (18%), lack of trust (17%), and slow delivery (16%) — all of which are addressable with CRO tactics.</strong></p>
          <p><dfn>Baymard Institute</dfn> — an independent web UX research organization that has conducted 48 large-scale usability studies of checkout flows — identifies these primary drivers:</p>
          ...
          <p className="text-foreground"><strong>Calculate your annual loss: Monthly visitors × Cart rate × Abandonment rate × AOV × 12. A store with 100K visitors, 15% cart rate, 70% abandonment, and $75 AOV loses $945,000 annually — recovering even 10% adds $94,500.</strong></p>
          ...
          <p className="text-foreground"><strong>Prevention is more effective than recovery — show all costs upfront, offer guest checkout, simplify form fields, add trust badges at checkout, and display social proof to validate the purchase decision.</strong></p>
          ...
          <p className="text-foreground"><strong>Social proof reduces abandonment by addressing trust concerns at checkout — real-time purchase notifications ("12 people bought this today"), satisfaction guarantees, and review snippets reassure hesitant shoppers at the critical moment.</strong></p>
          ...
          <p className="text-foreground"><strong>A three-email cart recovery sequence — reminder (1 hour), incentive (24 hours), final urgency (72 hours) — recovers 5–11% of abandoned carts, with the first email generating the highest conversion rate.</strong></p>
          ...
          <p className="text-foreground"><strong>Exit-intent popups on checkout pages recover 3–7% of abandoning visitors by offering a last-chance incentive, saving cart contents for later, or displaying social proof that addresses the likely objection.</strong></p>
          ...
          <p className="text-foreground"><strong>A frictionless checkout has 3 or fewer steps, supports guest checkout, auto-fills address fields, offers express payment, displays trust badges, and shows social proof — reducing abandonment rate by 20–35%.</strong></p>
