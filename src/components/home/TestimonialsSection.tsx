...
const testimonials = [
  {
    quote:
      "NotiProof increased our checkout conversions by 28% in the first month. The ROI is incredible.",
    highlight: "28%",
    name: "Jessica M.",
  ...
  {
    quote:
      "We saw a 19% lift in trial signups within two weeks. The analytics dashboard helps us optimize constantly.",
    highlight: "19%",
    name: "David K.",
    role: "SaaS Founder",
    company: "MetricFlow",
  ...
  {
    quote:
      "We now offer NotiProof as part of our CRO services. Clients love the results — 34% more leads on average.",
    highlight: "34%",
    name: "Anna P.",
    role: "Agency Owner",
    company: "GrowthLab",
  ...
  return (
    <section className="section-padding">
      <div className="container-tight">
        <SectionHeading
          badge="Testimonials"
          title="Over 2,000+ businesses trust NotiProof"
